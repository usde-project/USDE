...
import de.schildbach.wallet.usde.R;
...
public class Constants
{
	...
	public static final String SOURCE_URL = "https://github.com/usde/USDeAndroid/" + CoinDefinition.coinName + "-wallet";
	public static final String BINARY_URL = "http://code.google.com/p/bitcoin-wallet/downloads/list";
	public static final String CREDITS_BITCOINJ_URL = "https://github.com/usde/USDeAndroid/" + CoinDefinition.coinName + "j";
	public static final String CREDITS_ZXING_URL = "http://code.google.com/p/zxing/";
    public static final String CREDITS_WEBSITE_URL = "http://usd-e.com/";
    public static final String CREDITS_FORUM_URL = "http://usd-e.com/talk/";
	public static final String CREDITS_ICON_URL = "NA";

	public static final String AUTHOR_TWITTER_URL = "NA";
	public static final String AUTHOR_GOOGLEPLUS_URL = "NA";

	public static final String COMMUNITY_GOOGLEPLUS_URL = "NA";

	public static final String MARKET_APP_URL = "market://details?id=%s";
	public static final String WEBMARKET_APP_URL = "https://play.google.com/store/apps/details?id=%s";
	public static final String MARKET_PUBLISHER_URL = "market://search?q=pub:\"USDe\"";
